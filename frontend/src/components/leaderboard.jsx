      ...
      <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginTop: 16 }}>
          <div style={{ background: '#f8f8f7', borderRadius: 10, padding: 14 }}>
            <p style={{ fontSize: 12, fontWeight: 500, color: '#1D9E75', marginBottom: 8 }}>Matched skills</p>
          ...
          <div style={{ background: '#f8f8f7', borderRadius: 10, padding: 14 }}>
            <p style={{ fontSize: 12, fontWeight: 500, color: '#E24B4A', marginBottom: 8 }}>Missing skills</p>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 5 }}>
        ...
        <div style={{ marginTop: 16 }}>
          <p style={{ fontSize: 12, fontWeight: 500, marginBottom: 8 }}>Improvements</p>
    ...
    <div style={{ marginTop: 40 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
        {data.results.map((c, i) => (
          <div key={i} style={{
            background: '#fff',
            border: i === 0 ? '2px solid #1D9E75' : '1px solid #eee',
            ...
            <div style={{ flex: 1 }}>
              ...
              <p style={{ fontSize: 12, color: '#999' }}>{c.email || c.filename}</p>
            </div>
